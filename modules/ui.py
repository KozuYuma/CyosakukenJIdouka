...
# 色の代わりにこの印を隣の列に置く。
#
# 済んだもの（確定・作曲者/アーティスト一致）は印を出さない。数が多い上に
# もう手を入れる必要がなく、印が並ぶと「まだ何かある」ように見えるため。
# 手を入れる必要がある段階だけが目に入るようにする。
...
# 印の読み方。表の見出しに添えて出す
STATUS_MARK_LEGEND = "🟡 複数候補あり　🟠 要確認　🔴 該当なし　・ 未調査"
